...
// Print histooffshore of operation timings
static bool FLAGS_histooffshore = false;
...
int main(int argc, char** argv) {
  ...
  for (int i = 1; i < argc; i++) {
    ...
    } else if (sscanf(argv[i], "--histooffshore=%d%c", &n, &junk) == 1 &&
               (n == 0 || n == 1)) {
      FLAGS_histooffshore = n;

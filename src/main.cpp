...
// Copyright (c) 2013 OffshoreCoin developers
// Copyright (c) 2014 OffshoreCoin developers
...
int64 CTransaction::nMinTxFee = 0.0001 * COIN;  // Override with -mintxfee
...
const string strMessageMagic = "OffshoreCoin Signed Message:\n";
...
/** Amount of OffshoreCoins spent by the transaction.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("OffshoreCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("OffshoreCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("OffshoreCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running OffshoreCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("OffshoreCoinMiner terminated\n");
        throw;
    }
}

...
// Copyright (c) 2014 The OffshoreCoin developers
...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "OffshoreCoin begins";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
////////
        ...
        vSeeds.push_back(CDNSSeedData("node.OffshoreCoin.org", "node.OffshoreCoin.org"));
        vSeeds.push_back(CDNSSeedData("node.OffshoreCoin.cf", "node.OffshoreCoin.cf"));
        vSeeds.push_back(CDNSSeedData("OffshoreCoin.no-ip.org", "OffshoreCoin.no-ip.org"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("OffshoreCoin.test", "test.OffshoreCoin.org"));
